...
package ru.astrainteractive.aspekt.module.entities.gui.entities.util
...
internal fun EntityType.toMaterial() = when (this) {
    ...
    EntityType.LEASH_KNOT -> Material.BIG_DRIPLEAF_STEM
    ...
    EntityType.CHEST_MINECART -> Material.CHEST_MINECART
    ...
    EntityType.ARMADILLO -> Material.ARMADILLO_SPAWN_EGG
    EntityType.BOGGED -> Material.BOGGED_SPAWN_EGG
    EntityType.OMINOUS_ITEM_SPAWNER -> Material.OMINOUS_BOTTLE
    EntityType.FISHING_BOBBER -> Material.BARRIER
    EntityType.LIGHTNING_BOLT -> Material.BARRIER
}
