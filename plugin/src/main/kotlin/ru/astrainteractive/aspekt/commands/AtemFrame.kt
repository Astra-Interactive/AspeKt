...
fun CommandManager.atemFrameTabCompleter() = AspeKt.instance.registerTabCompleter("atemframe") {
    when (this.args.size) {
        1 -> listOf("isVisible")
        2 -> listOf("isFixed")
        3 -> listOf("radius")
...
fun CommandManager.atemFrame() = AspeKt.instance.registerCommand("atemframe") {
