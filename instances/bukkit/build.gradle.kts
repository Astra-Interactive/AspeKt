...
dependencies {
    ...
    shadow(projects.modules.antiswear)
    shadow(projects.modules.autocrop)
    shadow(projects.modules.broadcast)
    shadow(projects.modules.chatgame)
    ...
    shadow(projects.modules.invisibleItemFrames)
    shadow(projects.modules.jail)
    shadow(projects.modules.menu)
    shadow(projects.modules.moneyAdvancements)
    shadow(projects.modules.moneydrop)
    shadow(projects.modules.playtimeReward)
